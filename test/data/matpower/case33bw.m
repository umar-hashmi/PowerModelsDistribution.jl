...
%% bus data
%% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
...
mpc.bus = [  
	...
	32	1	0.210	0.1	0	0	1	1	0	12.66	1	1.1	0.9;
...
mpc.gencost = [
 ...
 %Vbase = mpc.bus(1, BASE_KV).*1000;      %% in Volts
 %Sbase = mpc.baseMVA.*1000000;              %% in VA
 %mpc.branch(:, [BR_R BR_X]) = mpc.branch(:, [BR_R BR_X]) / (Vbase^2 / Sbase);
 
 %% convert loads from kW to MW
 %mpc.bus(:, [PD, QD]) = mpc.bus(:, [PD, QD])./1000;
